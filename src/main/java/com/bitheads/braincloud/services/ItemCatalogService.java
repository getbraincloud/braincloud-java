...
public class ItemCatalogService {
    ...
    public void getCatalogItemDefinition(String defId, IServerCallback callback) {
        try {
            ...
            ServerCall sc = new ServerCall(ServiceName.itemCatalog, ServiceOperation.GET_CATALOG_ITEM_DEFINITION, data,
                    callback);
    ...
    public void getCatalogItemsPage(String context, IServerCallback callback) {
        try {
            ...
            ServerCall sc = new ServerCall(ServiceName.itemCatalog, ServiceOperation.GET_CATALOG_ITEMS_PAGE, data,
                    callback);
            _client.sendRequest(sc);
        } catch (JSONException ignored) {
        }
    ...
    public void getCatalogItemsPageOffset(String context, int pageOffset, IServerCallback callback) {
        try {
            ...
            ServerCall sc = new ServerCall(ServiceName.itemCatalog, ServiceOperation.GET_CATALOG_ITEMS_PAGE_OFFSET,
                    data, callback);
            _client.sendRequest(sc);
        } catch (JSONException ignored) {
        }
